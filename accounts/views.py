...
def register(request):
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            phonnumber = form.cleaned_data['phonnumber']
            ...
            messages.success(request, 'Thank you for registering with us. You account is now active')
            return redirect('/accounts/login/?command-verification_email&email='+ email)
    else:
      ...
      if user is not None:
          ...
          try:
              ...
              if is_cart_items_exists:
                ...
                #getting the the cartitem from the user to access his productvariation
...
def forgotpassword(request):
    if request.method =='POST':
        ...
        if Account.objects.filter(email=email):
           ...
           current_site = get_current_site(request)
           mail_subject ='please reset your passowrd'
           ...
           send_email = EmailMessage(mail_subject, message, to =[to_email])
           send_email.send()
           messages.success(request, 'An email has ben sent to you for password reset')
           return redirect('login')
        else:
...
def resetpassword(request):
    if request.method =='POST':
        ...
        if password == confirm_password:
            ...
            message.error(request, 'password does not match')
            return redirect('resetpassword')
    else:
    ...
    if request.method == 'POST':
       ...
       if new_password == confirm_password:
           ...
           if success:
              ...
              messages.error(request, 'please enter valid new current passwpord')
       else:
